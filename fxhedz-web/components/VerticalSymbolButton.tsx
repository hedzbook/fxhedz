  ...
  return (
    ...
    >
      <div className="flex flex-col items-center leading-[1.05]">
        <span className="text-[clamp(8px,5.33px+0.833vw,18px)] font-semibold tracking-wide">
          {base}
        </span>
        <span className="text-[clamp(8px,5.33px+0.833vw,18px)] text-neutral-400 tracking-wide">
          {quote}
        </span>
      </div>
    </button>
