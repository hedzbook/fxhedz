...
return (
  <div className="h-full bg-neutral-900 flex px-3">
    ...
    <div className="flex-1 h-full flex items-center text-left text-[clamp(8px,4.66px+1.0416vw,18px)] leading-none">
<div className="flex items-center gap-[clamp(4px,0.6vw,8px)]">
  ...
  <span className="font-semibold">{totalLots.toFixed(2)}</span>
    ...
    <div className="flex-1 h-full flex items-center justify-center text-[clamp(8px,4.66px+1.0416vw,18px)] leading-none">
<div className="flex items-center gap-[clamp(4px,0.6vw,8px)]">
  ...
  <span className={totalFloating >= 0 ? "text-green-400" : "text-red-400"}>
    ...
    <div className="flex-1 h-full flex items-center justify-end text-[clamp(8px,4.66px+1.0416vw,18px)] font-semibold text-sky-400 leading-none">
      {netState}
    </div>
